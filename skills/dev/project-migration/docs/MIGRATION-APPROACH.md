...
**Konsekuensi ke flow**: Migration Plan (Step 5) lebih dekat proses `implement` — spec ulang tiap behavior dan ikuti aturan canonical `../../shared/TDD.md` dari nol per modul.

## Option B — Port with Adjustments
...
**Konsekuensi ke flow**: Migration Plan (Step 5) lebih dekat proses `bug-diagnosis` — jaga behavior identik, test characterization dulu sebelum ubah apapun.
