...
## Option A — Phased (Legacy and New Projects Run Together)
...
**Konsekuensi ke flow**: Migration Plan (Step 5) butuh urutan fitur berdasarkan Risk Register, plus catatan koordinasi dua sistem jalan bersamaan (routing, data sync kalau perlu).

## Option B — Big Bang (Full Cutover)
...
**Konsekuensi ke flow**: Migration Plan (Step 5) lebih sederhana — tidak perlu step koordinasi dua sistem, tapi risiko terpusat di satu titik cutover akhir.
