 ...
 * emitting `resume: ""` and `model: "default"` alongside it —
 ...
 *
 * This is read once at tool registration — flipping the
...
interface AgentInvocationParams {
   ...
   * optional parameter has the same shape). The resolver below narrows by
