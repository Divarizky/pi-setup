...
export type TranscriptItem =
  ...
  | { readonly kind: "assistant"; readonly parts: ReadonlyArray<TranscriptPart> }
  | {
...
export type RunOutcome =
  ...
  | { readonly _tag: "Failed"; readonly errorText: string; readonly partialText?: string }
  | { readonly _tag: "Interrupted"; readonly partialText?: string }
  | { readonly _tag: "TimedOut"; readonly timeoutMs: number; readonly partialText?: string }

export type SubagentEvent =
  | { readonly _tag: "RunStarted" }
  | { readonly _tag: "RunSettled"; readonly outcome: RunOutcome }
  | { readonly _tag: "UserMessage"; readonly text: string }
  | { readonly _tag: "AssistantDelta"; readonly kind: "text" | "thinking"; readonly delta: string }
  | { readonly _tag: "AssistantMessage"; readonly parts: ReadonlyArray<TranscriptPart> }
  | {
  ...
  | { readonly _tag: "ToolUpdate"; readonly toolId: string; readonly outputPreview?: string }
  | {
  ...
  | { readonly _tag: "QueueChanged"; readonly queued: ReadonlyArray<QueuedMessage> }
  | { readonly _tag: "UsageChanged"; readonly tokens?: number; readonly contextWindow?: number }
  | { readonly _tag: "MetaChanged"; readonly meta: Partial<SubagentMeta> }
  | { readonly _tag: "BackendError"; readonly message: string }

// --- Snapshot ---------------------------------------------------------------

export type ReportOutcome = "success" | "failed" | "blocked" | "timeout" | "cancelled"

export interface SubagentErrorReport {
  readonly phase: "analysis" | "implementation" | "test" | "environment" | "runtime"
