...
/** Format turn count as a human-readable label. */
export function formatTurns(turnCount: number, maxTurns?: number | null): string {
  if (maxTurns != null) return `turn ${turnCount}/${maxTurns}`;
...
export class AgentWidget {
  ...
  private renderWidget(tui: any, theme: Theme): string[] {
    ...
    const lines: string[] = [truncate(theme.fg(headingColor, headingIcon) + " " + theme.fg(headingColor, "Subagents"))];
