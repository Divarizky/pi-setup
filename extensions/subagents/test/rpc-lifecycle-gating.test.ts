 ...
 * subagents still saw `subagents:ready` + a working `subagents:rpc:ping`,
...
describe("issue #142: RPC handlers + subagents:ready are gated on session_start", () => {
  ...
  beforeEach(() => {
    // Hermetic cwd + global dir keep session_start isolated from the
    // developer's filesystem and isolate the RPC wiring.
