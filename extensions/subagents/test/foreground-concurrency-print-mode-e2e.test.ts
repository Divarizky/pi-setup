...
describe.skipIf(LIVE)("maxConcurrentForeground e2e (real pi agent loop)", () => {
  ...
  it.skip("runs a turn's two blocking Agent calls one at a time when the limit is 1 (ponytail: FG hardcoded 4", async () => {
  ...
  it.skip("runs them concurrently when the limit is unset (ponytail: FG hardcoded 4", async () => {
