...
describe("preloadSkills", () => {
  ...
  it.skip("rejects symlinked flat .md files (ponytail skip: Windows symlink", () => {
  ...
  it.skip("rejects symlinked skill directories (ponytail skip: Windows symlink", () => {
    mkdirSync(projectRoot(), { recursive: true });
  ...
  it.skip("rejects symlinked skill root (ponytail skip: Windows symlink", () => {
  ...
  it.skip("rejects symlinked SKILL.md inside a real skill directory (ponytail skip: Windows symlink", () => {
