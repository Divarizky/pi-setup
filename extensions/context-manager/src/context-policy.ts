...
export function selectCompressionMode(percent: number | null | undefined): CompressionMode {
  if (percent !== null && percent !== undefined && percent < MODERATE_CONTEXT_THRESHOLD) {
    return "preserve";
  }
